...
import { Mail, MapPin, Phone, Banknote, Building2, Hash } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col animate-fade-in">
      ...
      <section className="section-padding bg-background animate-fade-in-up animation-delay-200">
        <div className="container mx-auto max-w-6xl grid lg:grid-cols-5 gap-16 container-padding">
          {/* Contact Details */}
          <div className="lg:col-span-2 space-y-10">
            <div>
                <h2 className="h2-typography mb-6 border-b pb-4">Get in Touch</h2>
             ...
             <div className="pt-10 border-t">
                <h2 className="h2-typography mb-6 border-b pb-4">Support Our Ministry</h2>
                 <div className="space-y-6">
                    <div className="flex items-start gap-4">
